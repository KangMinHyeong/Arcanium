...
public class WeaponHandler : MonoBehaviour, IDragHandler, IEndDragHandler
{
    ...
    void Start()
    {
        ...
        WeaponPrefab = Resources.Load<GameObject>(weaponData.WeaponModelPrefabPath);
        DisplayingModel = Instantiate(WeaponPrefab, transform.position, Quaternion.identity);
        
        Debug.Log(weaponData.WeaponPrefabPath);
        Debug.Log(weaponData.WeaponModelPrefabPath);
        Debug.Log("Init");
        // Init();
    }
