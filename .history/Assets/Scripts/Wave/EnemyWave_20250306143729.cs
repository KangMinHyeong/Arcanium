...
public class EnemyWave : MonoBehaviour
{
    ...
    {
        List<EnemyWaveData> EnemyWave = new List<EnemyWaveData>();
        ...
        if(CurrentWaveNum == 0)
        {
            ...
            EnemyWave = Waves[CurrentWaveNum];
            waveInfo.UpdateWaveInfo(EnemyWave);
        ...
        while(Waves.ContainsKey(CurrentWaveNum))
        {
            ...
            foreach (var wave in CurrentEnemyWave)
            {
