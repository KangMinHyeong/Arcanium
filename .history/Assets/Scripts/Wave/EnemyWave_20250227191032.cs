...
public class EnemyWave : MonoBehaviour
{
    ...
    Dictionary<int, List<GameObject>> EnemyPools = new Dictionary<string, List<GameObject>>();
    ...
    void InitEnemyPools()
    {
        foreach (var EnemyPrefabPath in EnemyPrefabPaths)
        {
            ...
            SetEnemyPools(EnemyPrefabPath.Key, EnemyPrefab);
        }
    }

    void SetEnemyPools(int EnemyID, GameObject EnemyPrefab)
    {
