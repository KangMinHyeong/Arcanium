...
public class GameManager : MonoBehaviour
{
    ...
    public StageData CurrentStageData { get {return StageData;} set {StageData = value;} }
    ...
    void LoadStageData()
    {
        WeaponDatabase Wrapper  = JsonUtility.FromJson<WeaponDatabase>(StageDataTable.text);
