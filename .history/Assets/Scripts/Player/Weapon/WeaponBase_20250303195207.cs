...
public class WeaponBase : MonoBehaviour
{
    ...
    {
        Debug.Log("x : " + transform.root.rotation.x);
        Debug.Log("y : " + transform.root.rotation.y);
        Debug.Log("z : " + transform.root.rotation.z);

        Quaternion newrotation = transform.root.rotation;
        newrotation.y += 0.25f;
