...
public class BeamSpawner : WeaponBase
{
    ...
    protected override void AttackTrigger()
    {
        ...
        // 빔처럼 한번에 캐스팅
        // int EnemyLayer = 6;
        Collider[] hitColliders = Physics.OverlapBox(boxCol.transform.position, boxCol.size * 0.5f, transform.rotation);
    ...
    void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(transform.parent.position, boxCol.size); // ✅ 노란색 박스 표시
    }
