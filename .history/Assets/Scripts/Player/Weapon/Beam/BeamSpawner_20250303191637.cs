...
public class BeamSpawner : WeaponBase
{
    ...
    protected override void AttackTrigger()
    {
        ...
        // 빔처럼 한번에 캐스팅
        // int EnemyLayer = 6;
        Collider[] hitColliders = Physics.OverlapBox(transform.position, boxCol.size * 0.5f, Quaternion.identity);
        ...
        Gizmos.DrawWireCube(transform.position, boxCol.size * 0.5f); // ✅ 노란색 박스 표시
