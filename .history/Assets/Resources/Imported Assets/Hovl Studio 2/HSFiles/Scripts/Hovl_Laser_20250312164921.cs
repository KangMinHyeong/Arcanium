...
public class Hovl_Laser : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Laser.material.SetTextureScale("_MainTex", new Vector2(1000.0f, 1000.0f));                    
        Laser.material.SetTextureScale("_Noise", new Vector2(1000.0f, 1000.0f));
        Debug.Log("SetTextureScale : " + Laser.material.GetTextureScale("_MainTex"));
